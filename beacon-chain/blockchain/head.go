...
func (s *Service) saveHeadNoDB(ctx context.Context, h *stateTrie.BeaconState, b *ethpb.SignedBeaconBlock, r [32]byte) error {
	...
	s.setHeadInitialSync(r, stateTrie.CopySignedBeaconBlock(b), h)
